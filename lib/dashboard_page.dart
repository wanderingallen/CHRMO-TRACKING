...
class _DashboardPageState extends State<DashboardPage>
  ...
  Future<void> _routeDocument({
    ...
    try {
      ...
      if (stableTs.isEmpty && !hasTrackingId && !hasNotifId) {
        final dbg = {
        ...
        if (mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text(
                'Cannot route: missing document identifier. $short (open details to copy debug)'),
